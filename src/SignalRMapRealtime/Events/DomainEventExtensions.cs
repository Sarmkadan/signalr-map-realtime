...
public static class DomainEventExtensions
{
    ...
    public static DomainEvent Clone(this DomainEvent domainEvent)
    {
        ...
        DomainEvent clone = domainEvent switch
        {
    ...
    /// Returns Guid.Empty if the event doesn't contain vehicle information.
    /// </summary>
    /// <param name="domainEvent">The domain event.</param>
    /// <returns>The vehicle ID or Guid.Empty if not applicable.</returns>
